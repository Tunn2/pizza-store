...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="HomeServlet">Mobile Shop</a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                    ...
                    <ul class="navbar-nav m-auto">
                        ...
                        %>
                        <li class="nav-item">
                            <p class="nav-link"><%= user.getFullName() %></p>
                        </li>
                        <li class="nav-item">
                        ...
                        <table class="table">
                            <form action="HomeServlet" method="POST">
                                <tr>
                                    ...
                                    <td><textarea class="form-control" name="name">${param.name}</textarea></td>
                                </tr>
                                <tr>
                                    <th scope="col">SupplierID</th>
                                    <td><input type="number" class="form-control" name="supplierID" value="${param.supplierID}"></td>
                                </tr>
                                <tr>
                                    <th scope="col">CategoryID</th>
                                    <td><input type="number" class="form-control" name="categoryID" value="${param.categoryID}"></td>
                                </tr>
                                <tr>
                                    <th scope="col">Price</th>
                                    <td><input type="number" class="form-control" name="price" value="${param.price}"></td>
                                </tr>
                                <tr>
                                    <th scope="col">Quantity</th>
                                    <td><input type="number" class="form-control" name="quantity" value="${param.quantity}"></td>
                                </tr>
                                <tr>
                                    <th scope="col">Image</th>
                                    <td><input type="text" class="form-control" name="image" value="${param.image}"></td>
                                </tr>
                                <tr>
                                    <th scope="col">Description</th>
                                    <td><textarea type="text" class="form-control" name="description">${param.description}</textarea></td>
                                </tr>
                                <tr>
