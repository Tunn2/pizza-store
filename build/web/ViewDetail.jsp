        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <table class="table">
                            <% PizzaDTO pizza = (PizzaDTO) request.getAttribute("PIZZA");
                                boolean isAdmin;
                                try {
                            ...
                            <tr>
                                ...
                                <td><%= pizza.getCategoryID() == 1 ? "American Pizza" : "Italian Pizza"%></td>
                            </tr>
                            <% } else {%>
                            <form action="HomeServlet" method="POST">
                                <tr>
                                    <th scope="col">Pizza ID</th>
                                    <td><input type="text" class="form-control" name="id" value="<%= pizza.getId() %>" readonly=""></td>
                                </tr>
                                <tr>
                                    <th scope="col">Name</th>
                                    <td><textarea class="form-control" name="name"><%= pizza.getName()%></textarea></td>
                                </tr>
                                <tr>
                                    <th scope="col">Description</th>
                                    <td><textarea class="form-control" name="description"><%= pizza.getDescription()%></textarea></td>
                                </tr>
                                <tr>
                                    <th scope="col">Price</th>
                                    <td><input type="number" class="form-control" name="price" value="<%= pizza.getPrice()%>"></td>
                                </tr>
                                <tr>
                                    <th scope="col">CategoryID</th>
                                    <td><input type="number" class="form-control" name="categoryID" value="<%= pizza.getCategoryID()%>"></td>
                                </tr>
                                <tr>
                                    <th scope="col">SupplierID</th>
                                    <td><input type="number" class="form-control" name="supplierID" value="<%= pizza.getSupplierID()%>"></td>
                                </tr>
                                <tr>
                                    <th scope="col">Quantity</th>
                                    <td><input type="number" class="form-control" name="quantity" value="<%= pizza.getQuantity()%>"></td>
                                </tr>
                                <tr>
                                    <th scope="col">Image</th>
                                    <td><input type="text" class="form-control" name="image" value="<%= pizza.getImage()%>"></td>
                                </tr>
                                <tr>
                                <input type="submit" class="btn btn-primary" name="action" value="Update">
                                <br><font color="red">${requestScope.MESSAGE}</font>
                                </tr>
                            </form>
                            <% }%>

                        </table>
                        <a class="link-offset-2 link-underline link-underline-opacity-0" href="HomeServlet">Back</a> 
                    </div>
                </div>
