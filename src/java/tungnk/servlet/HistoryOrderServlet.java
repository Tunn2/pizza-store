...
public class HistoryOrderServlet extends HttpServlet {
    ...
    private final String HISTORY_ORDER_PAGE = "ViewHistoryOrder.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session.getAttribute("USER") == null) {
                ...
                int id = aDao.getIDByUserName(username);
                OrderDAO oDao = new OrderDAO();
                List<OrderDTO> list = oDao.getListOrderByID(id);
                request.setAttribute("LIST_ORDER", list);
                url = HISTORY_ORDER_PAGE;
            }
